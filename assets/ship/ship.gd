...
## Local Y of the weather deck (measured deck plate sits at ~+1.5). Water rendering
## above this is cancelled inside the hull silhouette, and waves exceeding it drive
## the splash 'crash' intensity. Kept just under the visual surface to avoid z-fighting.
